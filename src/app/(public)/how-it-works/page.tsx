...
export default function HowItWorksPage(): React.JSX.Element {
  return (
    <ContentContainer className="flex flex-col items-center py-16">
      ...
      <section className="mb-24 grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {/* Step 1 */}
        <Card className="flex flex-col p-6 transition-colors hover:border-[var(--color-primary)]">
          <CardContent className="flex h-full flex-col p-0">
            ...
            <div className="mb-2 text-xs font-semibold uppercase tracking-widest text-[var(--color-primary)]">
              Step 1
            </div>
            ...
            <p className="flex-grow text-sm leading-6 text-[var(--color-text-secondary)]">
              Set realistic targets. Define both your &quot;Normal&quot; goal for good days and a &quot;Minimum&quot; viable effort for when energy is low.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col p-6 transition-colors hover:border-[var(--color-primary)]">
          <CardContent className="flex h-full flex-col p-0">
            ...
            <p className="flex-grow text-sm leading-6 text-[var(--color-text-secondary)]">
              Execute your habit based on today&apos;s reality. Listen to your body and mind to decide which level of effort is sustainable today.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col p-6 transition-colors hover:border-[var(--color-primary)]">
          <CardContent className="flex h-full flex-col p-0">
            ...
            <p className="flex-grow text-sm leading-6 text-[var(--color-text-secondary)]">
              One-tap logging. Easily record whether you hit your Full target or your Minimum target. Both count as a success.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col p-6 transition-colors hover:border-[var(--color-primary)]">
          <CardContent className="flex h-full flex-col p-0">
            ...
            <h3 className="mb-2 text-xl font-bold text-[var(--color-text-primary)]">Identify Friction</h3>
            <p className="flex-grow text-sm leading-6 text-[var(--color-text-secondary)]">
              Missed a day? That&apos;s data, not failure. Briefly note what got in the way in a completely judgment-free environment.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col p-6 transition-colors hover:border-[var(--color-primary)]">
          <CardContent className="flex h-full flex-col p-0">
            ...
            <p className="flex-grow text-sm leading-6 text-[var(--color-text-secondary)]">
              Receive smart, explained suggestions to adjust your targets based on your friction points. You are always in control of the changes.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col p-6 transition-colors hover:border-[var(--color-primary)]">
          <CardContent className="flex h-full flex-col p-0">
            ...
            <p className="flex-grow text-sm leading-6 text-[var(--color-text-secondary)]">
              A gentle bridge back to your routine after a major disruption. We help you restart smoothly without the pressure of &apos;catching up&apos;.
            </p>
          </CardContent>
        </Card>
      </section>
      ...
      {/* Final CTA Section */}
      <section className="mt-20 flex w-full max-w-3xl flex-col items-center text-center">
        <h2 className="mb-4 text-2xl font-bold text-[var(--color-primary)] sm:text-3xl">
          Ready to build sustainable habits?
        </h2>
        <p className="mb-8 max-w-lg text-sm leading-6 text-[var(--color-text-secondary)] sm:text-base">
          Join thousands who have abandoned the streak and embraced a compassionate, technical approach to personal growth.
        </p>
        <Button asChild size="large" className="bg-[var(--color-primary)] !text-white hover:bg-[var(--color-primary-hover)]">
          <Link className="!text-white font-semibold" href={routes.today}>Start Your Journey Free</Link>
        </Button>
      </section>
    </ContentContainer>
  );
