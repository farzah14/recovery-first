...
const detail: HabitDetailRead = {
  ...
  versions: [
    { id: 'version-2', versionNumber: 2, createdAt: '2026-08-03T00:00:00.000Z', source: 'redesign' },
    { id: 'version-1', versionNumber: 1, createdAt: '2026-08-01T00:00:00.000Z', source: 'creation' },
  ],
  sessions: [
    {
      id: 'session-full',
