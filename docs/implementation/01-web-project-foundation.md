...
- [ ] **Step 2: Initialize Git when the directory is not already a repository**
...
- [ ] **Step 3: Create foundational directories**
...
- [ ] **Step 4: Create Node version files**
...
- [ ] **Step 5: Create repository editor and line-ending policy**
...
- [ ] **Step 6: Create the initial Git ignore policy**
...
- [ ] **Step 8: Initialize package metadata and pin the active pnpm version**
...
- [ ] **Step 9: Create the initial lockfile**
...
- [ ] **Step 10: Commit repository initialization**
...
- [ ] **Step 2: Install TypeScript, Tailwind, and framework development dependencies**
...
- [ ] **Step 3: Add application scripts without replacing installed dependency versions**
...
- [ ] **Step 4: Create Next.js TypeScript declarations**
...
- [ ] **Step 5: Create the Tailwind PostCSS configuration**
...
- [ ] **Step 8: Commit the application dependency scaffold**
...
- [ ] **Step 1: Install formatting and architecture-test dependencies**
...
- [ ] **Step 3: Create ESLint flat configuration**
...
- [ ] **Step 5: Add formatting and architecture scripts**
...
- [ ] **Step 6: Create the failing domain-boundary source scan test**
...
- [ ] **Step 7: Run the currently available static checks**
...
- [ ] **Step 8: Commit strict engineering configuration**
...
- [ ] **Step 1: Create architectural directories**
...
- [ ] **Step 2: Track empty architectural directories**
...
- [ ] **Step 3: Write the failing route-inventory test**
...
- [ ] **Step 4: Create baseline Next.js runtime configuration**
...
- [ ] **Step 6: Create the minimal public route**
...
- [ ] **Step 7: Create the minimal application route**
...
- [ ] **Step 8: Create route-level error and missing-page surfaces**
...
- [ ] **Step 9: Run the route test and static checks**
...
- [ ] **Step 10: Commit repository architecture and route shell**
...
- [ ] **Step 3: Install the Vitest coverage provider**
...
- [ ] **Step 5: Create the shared render helper**
...
- [ ] **Step 6: Create the public-page component test**
...
- [ ] **Step 7: Add unit, component, integration, coverage, and aggregate test scripts**
...
- [ ] **Step 8: Run the complete test baseline**
...
- [ ] **Step 9: Commit the Vitest and component-test foundation**
...
- [ ] **Step 6: Commit browser testing infrastructure**
...
- [ ] **Step 2: Implement clock contracts**
...
- [ ] **Step 3: Write failing ID-generator tests**
...
- [ ] **Step 4: Implement ID-generator contracts**
...
- [ ] **Step 5: Write failing Result and AppError tests**
...
- [ ] **Step 6: Implement Result and AppError contracts**
...
- [ ] **Step 7: Write the failing structured logger test**
...
- [ ] **Step 8: Implement the structured logger with key-based redaction**
...
- [ ] **Step 9: Commit deterministic foundation contracts**
...
- [ ] **Step 2: Implement environment schemas**
...
- [ ] **Step 3: Create explicit browser environment reader**
...
- [ ] **Step 4: Create protected server environment reader**
...
- [ ] **Step 7: Verify that server-only variables are absent from browser modules**
...
- [ ] **Step 8: Commit environment contracts**
...
- [ ] **Step 3: Create a reusable server-only assertion module**
...
- [ ] **Step 6: Create route integration tests**
...
- [ ] **Step 7: Run focused tests and production build with explicit safe local values**
...
- [ ] **Step 8: Extend browser smoke coverage for liveness**
...
- [ ] **Step 9: Commit health and server-boundary infrastructure**
...
- [ ] **Step 1: Install the project-scoped Supabase CLI**
...
- [ ] **Step 2: Initialize Supabase Local**
...
- [ ] **Step 3: Set the local project identifier**
...
- [ ] **Step 5: Create deterministic seed data**
...
- [ ] **Step 6: Create the pgTAP database smoke test**
...
- [ ] **Step 8: Start the local stack and verify the baseline migration**
...
- [ ] **Step 9: Stop Supabase while preserving local volumes**
...
- [ ] **Step 10: Commit Supabase Local foundation**
...
- [ ] **Step 1: Create the environment-example checker**
...
- [ ] **Step 2: Create the repository-policy checker**
...
- [ ] **Step 3: Create tests for both repository tools**
...
- [ ] **Step 4: Create the verification orchestrator**
...
- [ ] **Step 5: Add repository check and verification scripts**
...
- [ ] **Step 6: Add TypeScript declarations for imported tool modules**
...
- [ ] **Step 7: Run tool tests and the baseline verification orchestrator**
...
- [ ] **Step 8: Commit verification tooling**
...
- [ ] **Step 3: Validate workflow references only existing package scripts**
...
- [ ] **Step 4: Run every workflow command locally**
...
- [ ] **Step 2: Create contribution rules**
...
- [ ] **Step 5: Document verification commands**
...
- [ ] **Step 6: Create ADR-001 through ADR-004**
...
- [ ] **Step 7: Create ADR-005 through ADR-008**
...
- [ ] **Step 8: Format and commit documentation**
...
- [ ] **Step 9: Run the complete Foundation quality gate from the working tree**
...
- [ ] **Step 10: Verify a clean checkout in a temporary directory**
...
- [ ] **Step 11: Return to the repository and capture final evidence**
...
- [ ] Node.js major version is 24 and pnpm is pinned in `package.json`.
- [ ] `pnpm install --frozen-lockfile` succeeds from a clean checkout.
- [ ] Next.js production build succeeds with explicit safe local environment values.
- [ ] Strict TypeScript produces zero errors.
- [ ] ESLint produces zero errors.
- [ ] Prettier check passes.
- [ ] Domain architecture boundary test passes.
- [ ] Deterministic clock, ID, Result, AppError, and logger tests pass.
- [ ] Environment validation tests pass.
- [ ] Liveness and readiness route tests pass.
- [ ] Component smoke test passes.
- [ ] Playwright passes in desktop and mobile Chromium.
- [ ] Supabase Local starts and resets from an empty database.
- [ ] Database smoke test reports four assertions and zero failures.
- [ ] Repository check finds no forbidden tracked file.
- [ ] `.env.example` contains all required Foundation keys and no real secret.
- [ ] GitHub Actions workflow references existing commands.
- [ ] Required ADR and operations documents exist.
- [ ] Working tree is clean.
