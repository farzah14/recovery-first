alter type public.entitlement_status add value if not exists 'trial_cancelled' before 'active';
  ...
  select case
    when exists (
      ...
      where user_id = p_user_id
        ...
        and status in ('trial_active', 'trial_cancelled', 'active', 'grace_period', 'cancelled', 'past_due')
